...
const MenuPage = () => {
  ...
  return (
    <div className="container">
      ...
      />
      <Stack className="menu-container" direction={isDesktop ? "row" : "column"}>
        <MenuCard title="Appetizers">
          <MealCard
            foodName="Chicken Pizza"
            imageSrc={pizza}
            price={12}
            description="Delicious chicken pizza with a crispy crust."
          />
          <MealCard
            foodName="Pepperoni Pizza"
            imageSrc={pepperonipizza}
            price={14}
            description="Classic pepperoni pizza with a tangy sauce."
          />
          <MealCard
            foodName="Veggie Pizza"
            imageSrc={veggiepizza}
            price={10}
            description="Healthy veggie pizza loaded with fresh vegetables."
          />
        </MenuCard>
        <MenuCard title="Main Courses">
          ...
          <MealCard
            ...
            imageSrc={spaghetti}
            price={15}
            description="Traditional spaghetti with rich bolognese sauce."
          />
          <MealCard
